...
# convention (see platform/ffreis-platform-bootstrap/internal/bootstrap for a
# reference implementation). A repo with no service boundary (pure library)
# may legitimately have none — this is a no-op, not a failure, in that case.
